...
import 'package:flutter_application_2/helpers/responsive.dart';
...
AppBar topNavigationBar(BuildContext context, GlobalKey<ScaffoldState> key) =>
    AppBar(
        ...
        title:Row(children: [
          ...
          CustomText(text: "Jane Doe", color: lightGrey,),
          SizedBox(
            width: 16,
          ),
          Container(
            decoration: BoxDecoration(
             ...
             child: Container(
              ...
              child: CircleAvatar(backgroundColor: light,
              child: Icon(Icons.person_2_outlined, color: dark,),),
             ),
          )
